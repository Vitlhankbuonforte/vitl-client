<template>
    ...
    <div v-else class="card p-1 lg:p-5 max-w-full">
        ...
        <div
            class="flex lg:flex-column justify-content-start overflow-x-scroll lg:overflow-x-hidden overflow-y-hidden lg:pb-2">
            <div v-for="lead, index of topPerformers" class="flex flex-column lg:flex-row m-3 my-2 align-items-center">
